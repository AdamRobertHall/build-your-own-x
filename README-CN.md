...
本仓库汇整了许多写得清晰、逐步引导的教程，教你如何从头重建我们喜爱的各种技术。
...
* [Shell（命令行解释器）](#build-your-own-shell)
...
* [**JavaScript / 伪代码**：_Computer Graphics from scratch_](http://www.gabrielgambetta.com/computer-graphics-from-scratch/introduction.html)
...
* [**Python**：_How To Make A Reddit Bot_](https://www.youtube.com/watch?v=krTUf7BpTc0) [视频]
...
* [**Python**：_Creating Reddit Bot with Python & PRAW_](https://www.youtube.com/playlist?list=PLIFBTFgFpoJ9vmYYlfxRFV6U_XhG-4fpP) [视频]
...
* [**Go**：_Building a container from scratch in Go_](https://www.youtube.com/watch?v=8fi7uSYlOdc) [视频]
...
* [**C++**：_NES Emulator From Scratch_](https://www.youtube.com/playlist?list=PLrOv9FMX8xJHqMvSGB_9G9nZZ_4IgteYf) [视频]
...
* [**JavaScript**：_Building React From Scratch_](https://www.youtube.com/watch?v=_MAD4Oly9yg) [视频]
...
* [**JavaScript**：_Redux: Implementing Store from Scratch_](https://egghead.io/lessons/react-redux-implementing-store-from-scratch) [视频]
...
* [**JavaScript**：_Building a Custom React Renderer_](https://youtu.be/CGpMlWVcHok) [视频]

#### 从零实现 `游戏`

* [**C**：_Handmade Hero_](https://handmadehero.org/)
* [**C**：_How to Program an NES game in C_](https://nesdoug.com/)
* [**C**：_Chess Engine In C_](https://www.youtube.com/playlist?list=PLZ1QII7yudbc-Ky058TEaOstZHVbT-2hg) [视频]
* [**C**：_Let's Make: Dangerous Dave_](https://www.youtube.com/playlist?list=PLSkJey49cOgTSj465v2KbLZ7LMn10bCF9) [视频]
* [**C**：_Learn Video Game Programming in C_](https://www.youtube.com/playlist?list=PLT6WFYYZE6uLMcPGS3qfpYm7T_gViYMMt)
  [视频]
* [**C**：_Coding A Sudoku Solver in C_](https://www.youtube.com/playlist?list=PLkTXsX7igf8edTYU92nU-f5Ntzuf-RKvW) [视频]
* [**C**：_Coding a Rogue/Nethack RPG in C_](https://www.youtube.com/playlist?list=PLkTXsX7igf8erbWGYT4iSAhpnJLJ0Nk5G) [视频]
...
* [**C++**：_Remaking Cavestory in C++_](https://www.youtube.com/watch?v=ETvApbD5xRo&list=PLNOBk_id22bw6LXhrGfhVwqQIa-M2MsLa) [视频]
* [**C++**：_Reconstructing Cave Story_](https://www.youtube.com/playlist?list=PL006xsVEsbKjSKBmLu1clo85yLrwjY67X) [视频]
...
* [**Go**：_Games With Go_](https://www.youtube.com/playlist?list=PLDZujg-VgQlZUy1iCqBbe5faZLMkA3g2x) [视频]
* [**Java**：_Code a 2D Game Engine using Java - Full Course for Beginners_](https://www.youtube.com/watch?v=025QFeZfeyM) [视频]
...
* [**JavaScript**：_Build your own 8-Ball Pool game from scratch_](https://www.youtube.com/watch?v=aXwCrtAo4Wc) [视频]
...
* [**JavaScript / Java**：_Neural Networks - The Nature of Code_](https://www.youtube.com/playlist?list=PLRqwX-V7Uu6aCibgK1PTWWu9by6XFdCfh) [视频]
...
* [**C**：_Building a software and hardware stack for a simple computer from scratch_](https://www.youtube.com/watch?v=ZjwvMcP3Nf0&list=PLU94OURih-CiP4WxKSMt3UcwMSDM3aTtX) [视频]
...
* [**C**：_Kernel 201 – Let’s write a Kernel with keyboard and screen support_](https://arjunsreedharan.org/post/99370248137/kernel-201-lets-write-a-kernel-with-keyboard-and-screen-support)
...
* [**C++**：_Write your own Operating System_](https://www.youtube.com/playlist?list=PLHh55M_Kq4OApWScZyPl5HhgsTJS9MZ6M) [视频]
...
* [**C++**：_3D Physics Engine Tutorial_](https://www.youtube.com/playlist?list=PLEETnX-uPtBXm1KEr_2zQ6K_0hoGH6JJ0) [视频]
...
* [**C++**：_Writing Your Own Toy Compiler Using Flex_](https://gnuu.org/2009/09/09/writing-your-own-toy-compiler/)
* [**C++**：_How to Create a Compiler_](https://www.youtube.com/watch?v=eF9qWbuQLuw) [视频]
...
* [**Elixir**：_Demystifying compilers by writing your own_](https://www.youtube.com/watch?v=zMJYoYwOCd4) [视频]
* [**Go**：_The Super Tiny Compiler_](https://github.com/hazbo/the-super-tiny-compiler)
* [**Go**：_Lexical Scanning in Go_](https://www.youtube.com/watch?v=HxaD_trXwRE) [视频]
...
* [**Java**：_Creating JVM Language_](https://jakubdziworski.github.io/categories.html#Enkel-ref)
...
* [**JavaScript**：_Little Lisp interpreter_](http://maryrosecook.com/blog/post/little-lisp-interpreter)
...
* [**OCaml**：_Writing a Lisp, the series_](https://bernsteinbear.com/blog/writing-a-lisp/)
...
* [**Python**：_Make Your Own Simple Interpreted Programming Language_](https://www.youtube.com/watch?v=dj9CBS3ikGA&list=PLZQftyCk7_SdoVexSmwy_tBgs7P0b97yD&index=1) [视频]
...
* [**Python**：_Building A Python-Based Search Engine_](https://www.youtube.com/watch?v=cY7pE7vX6MU) [视频]
...
* [**Python**：_Python Tutorial: Make Your Own Text Editor_](https://www.youtube.com/watch?v=xqDonHEYPgA) [视频]
...
* [**C++**：_Writing a Linux Debugger_](https://blog.tartanllama.xyz/writing-linux-debugger-setup/)
...
* [**Java**：_How to Build an Android Reddit App_](https://www.youtube.com/playlist?list=PLgCYzUzKIBE9HUJU-upNvl3TRVAo9W47y) [视频]
...
* [**Python**：_Build a Deep Learning Library_](https://www.youtube.com/watch?v=o64FV-ez6Gw) [视频]
...
* [**Python**：_Stock Market Predictions with LSTM in Python_](https://lethalbrains.com/learn-ml-algorithms-by-coding-decision-trees-439ca503c9a4)
...
* [**Python**：_Learn ML Algorithms by coding: Decision Trees_](https://lethalbrains.com/learn-ml-algorithms-by-coding-decision-trees-439ca503c9a4)
...
* 欢迎投稿，直接发 PR，或 [创建一个 issue](https://github.com/codecrafters-io/build-your-own-x/issues/new)
* 帮助我们审查 [待处理的投稿](https://github.com/codecrafters-io/build-your-own-x/issues)，通过评论或表情参与

## 起源与许可

[![CC0](https://mirrors.creativecommons.org/presskit/buttons/88x31/svg/cc-zero.svg)](https://creativecommons.org/publicdomain/zero/1.0/)

本仓库由 [众多贡献者](https://github.com/codecrafters-io/build-your-own-x/graphs/contributors) 的工作汇集而成。该项目最初由 [Daniel Stefanovic](https://github.com/danistefanovic) 发起，目前由 [CodeCrafters, Inc.](https://codecrafters.io) 维护。在法律允许的最大范围内，[CodeCrafters, Inc.](https://codecrafters.io) 已放弃对此作品的著作权及相关或邻接权利。
